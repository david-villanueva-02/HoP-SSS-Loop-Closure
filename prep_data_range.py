...
def prepare_data_range(input_dir: str, output_dir: str, segment_size: int, overlap_size: int, upper_limit: int, side: str, data_lower_limit: int, data_upper_limit: int):
...
if __name__ == "__main__":
    ...
    prepare_data(input_dir, output_dir, segment_size, overlap_size, upper_limit, side="left", data_lower_limit= 1500, data_upper_limit= 3500)